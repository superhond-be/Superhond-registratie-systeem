/**
 * public/js/layout.js — Topbar & Footer mount (v0.20.5)
 * - Dashboard = gele topbar (#f4c400), Subpages = blauwe topbar (#2563eb)
 * - Contrasterende status (“Online/Offline”)
 * - Consistente inner .topbar-inner.container
 * - Admin badge + density zoals eerder
 */
(function () {
  const LS_ADMIN='superhond:admin:enabled', LS_DENSITY='superhond:density';
  const API_CONFIG='/api/config', API_PING='/api/ping';
  ...
  function renderTopbar(container, opts, cfg, online){
    ...
    // Kleur kiezen (dashboard geel, anders blauw) en hard toepassen
